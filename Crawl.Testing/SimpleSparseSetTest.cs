...
public class SimpleSparseSetTest
{
    ...
    public void SparseSet_BasicOperations_ShouldWork()
    {
        ...
        var sparseSet = new SparseSet<SimpleTestComponent>(maxEntityId: 10000, initialCapacity: 100);
    ...
    public void SparseSet_PageBoundaryTest_ShouldWork()
    {
        ...
        var sparseSet = new SparseSet<SimpleTestComponent>(maxEntityId: 10000);
    ...
    public void SparseSet_SwapAndPopRemoval_ShouldWork()
    {
        ...
        bool removed = sparseSet.Remove(20u);
