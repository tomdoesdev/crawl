...
public readonly struct SpriteComponent : IComponent
{
    ...
    public override bool Equals(object? obj) => obj is SpriteComponent;
    public override int GetHashCode() => ComponentType.GetHashCode();
}
...
public readonly struct VelocityComponent(float speed) : IComponent
{
    ...
    public override int GetHashCode() => Speed.GetHashCode();
}
...
public class ComponentManagerTests
{
    ...
    public void AddComponent_SingleComponent_AddsSuccessfully()
    {
        ...
        _componentManager.AddComponent(_entity1, position);
        
        var retrieved = _componentManager.GetComponent<TestPositionComponent>(_entity1);
    ...
    public void AddComponent_MultipleComponentTypes_AddsAllCorrectly()
    {
        ...
        _componentManager.AddComponent(_entity1, position);
        _componentManager.AddComponent(_entity1, velocity);
        _componentManager.AddComponent(_entity1, sprite);
        
        Assert.Equal(position, _componentManager.GetComponent<TestPositionComponent>(_entity1));
        Assert.Equal(velocity, _componentManager.GetComponent<VelocityComponent>(_entity1));
        Assert.Equal(sprite, _componentManager.GetComponent<SpriteComponent>(_entity1));
    }
    ...
    public void AddComponent_SameComponentTypeDifferentEntities_StoresCorrectly()
    {
        ...
        _componentManager.AddComponent(_entity1, pos1);
        _componentManager.AddComponent(_entity2, pos2);
        _componentManager.AddComponent(_entity3, pos3);
        
        Assert.Equal(pos1, _componentManager.GetComponent<TestPositionComponent>(_entity1));
        Assert.Equal(pos2, _componentManager.GetComponent<TestPositionComponent>(_entity2));
        Assert.Equal(pos3, _componentManager.GetComponent<TestPositionComponent>(_entity3));
    }
    ...
    public void AddComponent_DuplicateComponentToSameEntity_ThrowsDuplicateComponentException()
    {
        ...
        Assert.Throws<DuplicateComponentException>(() => _componentManager.AddComponent(_entity1, pos2));
    }
    ...
    public void GetComponent_NonRegisteredComponentType_ThrowsException()
    {
        ...
        var exception = Assert.Throws<Exception>(() => _componentManager.GetComponent<TestPositionComponent>(_entity1));
        Assert.Contains("Component type Crawl.Test.TestPositionComponent does not exist", exception.Message);
    }
    ...
    public void GetComponent_RegisteredTypeButEntityDoesntHaveIt_ThrowsComponentNotFoundException()
    {
        ...
        Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<TestPositionComponent>(_entity2));
    }
    ...
    public void GetComponent_AfterMultipleAddsAndGets_ConsistentResults()
    {
        ...
        _componentManager.AddComponent(_entity1, pos1);
        _componentManager.AddComponent(_entity2, pos2);
        _componentManager.AddComponent(_entity1, vel1);
        _componentManager.AddComponent(_entity2, vel2);
        ...
        for (int i = 0; i < 5; i++)
        {
            Assert.Equal(pos1, _componentManager.GetComponent<TestPositionComponent>(_entity1));
            Assert.Equal(pos2, _componentManager.GetComponent<TestPositionComponent>(_entity2));
            Assert.Equal(vel1, _componentManager.GetComponent<VelocityComponent>(_entity1));
            Assert.Equal(vel2, _componentManager.GetComponent<VelocityComponent>(_entity2));
        }
    }
    ...
    public void ComponentManager_TypeRegistration_WorksCorrectly()
    {
        ...
        _componentManager.AddComponent(_entity1, position);
        _componentManager.AddComponent(_entity2, velocity);
        
        // Should be able to get components back
        Assert.Equal(position, _componentManager.GetComponent<TestPositionComponent>(_entity1));
        Assert.Equal(velocity, _componentManager.GetComponent<VelocityComponent>(_entity2));
        ...
        _componentManager.AddComponent(_entity3, position2);
        _componentManager.AddComponent(_entity3, velocity2);
        
        Assert.Equal(position2, _componentManager.GetComponent<TestPositionComponent>(_entity3));
        Assert.Equal(velocity2, _componentManager.GetComponent<VelocityComponent>(_entity3));
    }
    ...
    public void ComponentManager_ComplexScenario_WorksCorrectly()
    {
        ...
        _componentManager.AddComponent(_entity3, new SpriteComponent());
        ...
        Assert.Equal(new SpriteComponent(), _componentManager.GetComponent<SpriteComponent>(_entity3));
        
        // Verify entities don't have components they shouldn't
        Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<SpriteComponent>(_entity2));
        Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<TestPositionComponent>(_entity3));
        Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<VelocityComponent>(_entity3));
    }
    ...
    public void ComponentManager_WithManyEntities_PerformsWell()
    {
        ...
        for (uint i = 1; i <= entityCount; i++)
        {
            ...
            var actualPosition = _componentManager.GetComponent<TestPositionComponent>(entity);
    ...
    public void ComponentManager_MixedComponentTypes_HandlesCorrectly()
    {
        ...
        _componentManager.AddComponent(entities[0], new TestPositionComponent(1, 1));
        _componentManager.AddComponent(entities[0], new VelocityComponent(1.0f));
        _componentManager.AddComponent(entities[0], new SpriteComponent());
        
        // Entity 2: Position + Velocity
        _componentManager.AddComponent(entities[1], new TestPositionComponent(2, 2));
        _componentManager.AddComponent(entities[1], new VelocityComponent(2.0f));
        
        // Entity 3: Only Position
        _componentManager.AddComponent(entities[2], new TestPositionComponent(3, 3));
        
        // Entity 4: Only Velocity
        _componentManager.AddComponent(entities[3], new VelocityComponent(4.0f));
        
        // Entity 5: Only Sprite
        _componentManager.AddComponent(entities[4], new SpriteComponent());
        
        // Verify correct components exist
        Assert.Equal(new TestPositionComponent(1, 1), _componentManager.GetComponent<TestPositionComponent>(entities[0]));
        Assert.Equal(new VelocityComponent(1.0f), _componentManager.GetComponent<VelocityComponent>(entities[0]));
        Assert.Equal(new SpriteComponent(), _componentManager.GetComponent<SpriteComponent>(entities[0]));
        
        Assert.Equal(new TestPositionComponent(2, 2), _componentManager.GetComponent<TestPositionComponent>(entities[1]));
        Assert.Equal(new VelocityComponent(2.0f), _componentManager.GetComponent<VelocityComponent>(entities[1]));
        
        Assert.Equal(new TestPositionComponent(3, 3), _componentManager.GetComponent<TestPositionComponent>(entities[2]));
        Assert.Equal(new VelocityComponent(4.0f), _componentManager.GetComponent<VelocityComponent>(entities[3]));
        Assert.Equal(new SpriteComponent(), _componentManager.GetComponent<SpriteComponent>(entities[4]));
        
        // Verify missing components throw exceptions
        Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<SpriteComponent>(entities[1]));
        Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<VelocityComponent>(entities[2]));
        Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<TestPositionComponent>(entities[3]));
    }
    ...
    public void ComponentManager_ErrorHandling_ProvidesInformativeMessages()
    {
        ...
        var exception1 = Assert.Throws<Exception>(() => _componentManager.GetComponent<TestPositionComponent>(_entity1));
        Assert.Contains("Component type", exception1.Message);
        Assert.Contains("does not exist", exception1.Message);
        
        // Registered type but entity doesn't have it
        _componentManager.AddComponent(_entity1, new TestPositionComponent(10, 20));
        var exception2 = Assert.Throws<ComponentNotFoundException>(() => _componentManager.GetComponent<TestPositionComponent>(_entity2));
        Assert.Contains("Entity 2 does not exist", exception2.Message);
    }
